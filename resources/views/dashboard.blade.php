...
<div class="dashboard-page mx-auto max-w-7xl space-y-8">
    <div class="dashboard-hero">
        ...
        <a href="{{ route('referrals.create') }}" class="btn-accent"><span class="text-lg leading-none">+</span> New referral</a>
    </div>
    ...
    <section class="dashboard-queue">
        @if ($referrals->isEmpty())
            <div class="dashboard-empty"><div class="dashboard-empty__icon">↗</div><h2>No referrals yet</h2><p>Create your first patient referral to start the handover.</p><a href="{{ route('referrals.create') }}" class="btn-accent mt-5">Create a referral</a></div>
        @else
